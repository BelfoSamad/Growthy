//Getting data from popup (through session)
//let watch_time = sessionStorage.getItem("watch-time");
//let game_time = sessionStorage.getItem("game-time");
//let enabled = sessionStorage.getItem("enabled"); (use chrome.runtime.reload() to update
